...
public class Nombre  {
    ...
    public static final String encuesta = "participacion_ciudadana";
//    public static final String USUARIO = "usuario";
    ...
    public String nombreEncuesta(){
        ...
        final String nombreEncuesta = "participacion_ciudadana";
        return nombreEncuesta;
    }

    public String nombreDatos(){

        final String nombreEncuesta = "datos_participacion_ciudadana";
        return nombreEncuesta;
    }
