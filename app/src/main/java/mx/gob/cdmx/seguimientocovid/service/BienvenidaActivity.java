...
//    private TransparentProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread.setDefaultUncaughtExceptionHandler(new UnCaughtException(BienvenidaActivity.this,this));

        AppWidgetManager manager = AppWidgetManager.getInstance(this);
        int[] ids = manager.getAppWidgetIds(new ComponentName(this,mx.gob.cdmx.seguimientocovid.service.GPSWidgetProvider.class));
...
//		}
    ...
    public void requestPinAppWidget(){
        ...
        ComponentName myProvider = new ComponentName(this, mx.gob.cdmx.seguimientocovid.service.GPSWidgetProvider.class);
